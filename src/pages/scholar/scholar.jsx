					...
					<div className='container'>
						...
						<div className='about-us'>
							...
							<p className='about-us__text'>
								{language[lang].scholar.main_text}
							</p>
						</div>
					</div>
				</div>
						...
						<div className='scholar__box'>
							...
							<div className='d-flex'>
								...
								<p className='scholar__text'>
									...
									O‘zbek SSR xalq shoiri (1926). U mumtoz she’riyat vaznini
									(Aruz) xalq she’riyati (Barmoq) vazni hisobiga to‘ldirgan.
									Hamza O‘zbekiston madaniyati tarixi rivojiga nafaqat shoir va
							...
							<p className='scholar__text'>
								...
								ushbu mavzularga uyg‘unlashgan. 1916 – 1919-yillarda Hamza
								yettita she’riy to‘plamini nashr etadi, ularda shoirning
